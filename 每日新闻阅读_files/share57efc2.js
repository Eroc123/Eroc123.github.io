...
var a=m._oElements[o],t={},c=a.getAttribute("voice_encode_fileid")||"";
try{
c=decodeURIComponent(c);
}catch(d){}
t.voiceid=s.encodeStr(c),t.voiceid=t.voiceid.replace(/&#61;/g,"=").replace(/^\s/,"").replace(/\s$/,""),
t.isaac=1*a.getAttribute("isaac2")||0,t.src=m.srcRoot.replace("#meidaid#",t.voiceid),
...
!1):void 0;
}),n(a,t,i),"undefined"!=typeof voiceid&&c&&voiceid&&c===voiceid&&!function(){
var e=a.offsetTop+122-40;
setTimeout(function(){
window.scrollTo(0,e);
},0);
}(),i++);
...
if(i.title=s.encodeStr(a).replace(/^\s/,"").replace(/\s$/,""),i.fileSize=1*e.getAttribute("high_size")||0,
...
var o=i.voiceid+"_"+i.posIndex,a=e.parentNode.querySelector('[data-preloadingid="'+o+'"]');
a&&a.parentNode.removeChild(a),t(i),m.musicList[i.voiceid+"_"+i.posIndex]=i;
});
}
function t(e){
var i=e.voiceid+"_"+e.posIndex,o="";
if(window.voice_in_appmsg&&window.voice_in_appmsg[e.voiceid]){
var a=window.voice_in_appmsg[e.voiceid],n=window.biz||"",t=window.mid||"",d=window.idx||"";
a.bizuin&&a.appmsgid&&a.idx&&(n=a.bizuin,t=a.appmsgid,d=a.idx);
var r=window.location.protocol||"https:";
o=r+"//mp.weixin.qq.com/mp/audio?_wxindex_=#_wxindex_#&scene=104&__biz=#biz#&mid=#mid#&idx=#idx#&voice_id=#voice_id#&sn=#sn##wechat_redirect".replace("#_wxindex_#",e.posIndex).replace("#biz#",n).replace("#mid#",t).replace("#idx#",d).replace("#voice_id#",e.voiceid).replace("#sn#",a.sn||"");
}
l("[Voice] init"+o);
...
w&&w.spad&&d(w.spad.val),e.hasSpAd&&window.setInterval(function(){
r();
var e=_();
...
var A=j.getAttribute("data-linktype"),I=j.getAttribute("href");
...
return y&&(g[I]&&g[I].subject_name&&"0"===g[I].item_show_type&&g[I].title?o(y,{
title:'即将打开公众号 "'+g[I].subject_name+'" 的'+_[g[I].item_show_type],
desc:h.innerText="《"+g[I].title+"》"
}):g[I]&&g[I].subject_name&&g[I].item_show_type>=0?o(y,{
desc:'即将打开公众号 "'+g[I].subject_name+'" 的'+_[g[I].item_show_type]
}):o(y,{
desc:"即将打开新的页面"
})),r.stopPropagation(),"undefined"==typeof w[I]&&(I.indexOf("mp.weixin.qq.com/s/")>-1||I.indexOf("mp.weixin.qq.com/s?")>-1)?p.setSum(110809,6,1):"undefined"==typeof w[I]&&p.setSum(110809,7,1),
w=function(){
return g[I]&&g[I].item_show_type>=0&&s.indexOf("mp.weixin.qq.com")>-1&&(u.isIOS||u.isAndroid)&&!u.isInMiniProgram&&u.isWechat?1==j.getAttribute("clicked")?!1:(l.invoke("openWebViewUseFastLoad",{
url:s,
item_show_type:g[I].item_show_type,
openType:0,
scene:1
},function(e){
console.log("openWebViewUseFastLoad res: ",e),e&&e.err_msg&&-1==e.err_msg.indexOf("ok")?l.invoke("openUrlWithExtraWebview",{
url:s,
openType:1
},function(e){
...
}),!1):void(u.isInMiniProgram?location.href=s:(u.isAndroid||u.isIOS)&&u.isWechat?a(s,{
sample:1,
reject:function(){
location.href=s;
}
}):location.href=s);
},("1"===A||i(j)||n(j))&&m.report([2,m.getRedirectType(I),"",window.img_popup?1:0,window.source,m.getUrlData(I)],!0),
("1"===A||i(j)||n(j))&&window.img_popup?(console.log("tap img link",y),y.style.display="block",
setTimeout(function(){
h&&h.focus();
},100),v&&v.setAttribute("aria-hidden","true"),y._url=I,(i(j)||n(j))&&(p.setSum(110809,8,1),
y._type="OTHER"),document.querySelector("body").addEventListener("touchmove",t,{
passive:!1
})):w(),!1;
},!0),s.on(j,"click",function(e){
("1"===A||"2"===A||i(j)||n(j))&&window.img_popup&&(e.preventDefault(),e.stopPropagation());
},!0);
}(j);
}
var s=e("biz_common/dom/event.js"),a=e("appmsg/open_url_with_webview.js"),l=e("biz_wap/jsapi/core.js"),u=e("biz_wap/utils/mmversion.js"),m=(e("biz_wap/utils/ajax.js"),
...
i=null;
var o=document.getElementById("js_content"),n=o.offsetWidth,_=n/l.getRatio();
window.logs.video_cnt=0;
for(var r=0,s=a.length;s>r;++r){
var d=a[r],p=d.getAttribute("data-src")||"",m=d.getAttribute("src")||p;
if(m){
var c=e("pages/version4video.js");
if(0==m.indexOf("http://z.weishi.com/weixin/player.html"))m=m.replace(/width=\d+/g,"width="+n),
m=m.replace(/height=\d+/g,"height="+_),d.width=n,d.height=_,d.style.setProperty&&(d.style.setProperty("width",n+"px","important"),
d.style.setProperty("height",_+"px","important")),d.setAttribute("src",m),window.__addIdKeyReport&&window.__addIdKeyReport("28307",10),
window.logs.video_cnt++;else{
if(/http(s)*\:\/\/v\.qq\.com\/iframe\/(preview|player)\.html\?/.test(m)){
if(!c.isShowMpVideo()){
var w;
...
/^http(s)*\:\/\/mp\.weixin\.qq\.com\/mp\/readtemplate\?t=pages\/video_player_tmpl/.test(m)&&window.logs.video_cnt++;
}
}
}
...
function t(e){
var i=e.getAttribute("data-src")||e.getAttribute("src"),t=m.getQuery("vid",i),r=e.getAttribute("data-vw"),s=e.getAttribute("data-vh"),o=e.getAttribute("data-ratio"),n=document.createElement("span");
...
{
var l=p.children[0],m=n.parentNode,w=m.insertBefore(l,n),u=w.children[0];
(function(e,i){
...
var p=e("appmsg/like.js"),l=document.getElementById("like3"),m=document.getElementById("likeNum3");
if(!l||!m)return;
...
var m=new Image;
return m.src=("http://mp.weixin.qq.com/mp/jsreport?1=1&key=1&content=biz:"+biz+",mid:"+mid+",uin:"+uin+"[key1]"+encodeURIComponent(l.toString())+"&r="+Math.random()).substr(0,1024),
console&&console.error(l),void("undefined"!=typeof window.WX_BJ_REPORT&&window.WX_BJ_REPORT.BadJs&&WX_BJ_REPORT.BadJs.onError(l));
}
},
onError:function(){
var e=new Image;
...
var n=e("appmsg/reward_utils.js"),_=e("appmsg/pay_read/pay_read_utils.js"),d=e("appmsg/pay_report_utils.js"),p=e("pages/create_txv.js"),l=e("pages/video_ctrl.js"),m=e("biz_common/utils/url/parse.js"),c=e("appmsg/img_copyright_tpl.html.js"),w=e("appmsg/appmsgext.js"),u=(e("appmsg/share_tpl.html.js"),
...
for(var r=+new Date,h=[],d=this.sw,f=this,g=-1,p=0,u=t.length;u>p;p++)!function(t,i){
...
p=60),(!t.show&&(s.top<=0&&s.top+s.height+f>=0||s.top>0&&s.top<e+p)||i.isAccessibility)&&(i.inImgRead&&(s.top<=0&&s.top+s.height>=0||s.top>0&&s.top<e)&&i.inImgRead(r,networkType),
i.changeSrc&&(r=i.changeSrc(t.loader,r,g,t.placeholder)),t.loader.onerror=function(){
var e=this;
...
var g=t.item(d),p=l(g,a),u=l(g,"src");
if(p&&!(u&&u.indexOf("data:image/gif;base64")<0)){
var b=100;
if(g.dataset&&g.dataset.ratio){
var A=1*g.dataset.ratio,w=1*g.dataset.w||n;
"number"==typeof A&&A>0?(w=n>=w?w:n,b=w*A,r||(g.style.width&&g.setAttribute("_width",g.style.width),
c(g,"width",w+"px","important"),c(g,"visibility","visible","important"),g.setAttribute("src",h))):c(g,"visibility","hidden","important");
}else c(g,"visibility","hidden","important");
r||c(g,"height",b+"px","important"),m&&-1==p.indexOf("mmsns.qpic.cn")&&!(p.match(/\:\/\/[^\/]+\/mmbiz\//)&&p.indexOf("wx_fmt=gif")>-1||p.match(/\:\/\/[^\/]+\/mmbiz_gif\//))&&(g.crossOrigin="anonymous"),
g.alt="Image",e.push({
placeholder:g,
loader:g.cloneNode(),
src:p,
...
var a=[r,"mpshare=1","scene="+i,"srcid="+srcid,"sharer_sharetime="+n,"sharer_shareid="+p];
if(""!=o&&a.push(o),r=a.join("&"),2===i&&d&&d.indexOf(h)>-1){
var s=Math.floor(Math.random()*_.length),m=_[s];
...
var o=e("biz_common/utils/url/parse.js"),r=e("biz_wap/utils/mmversion.js"),a=e("appmsg/appmsg_report.js"),s=e("appmsg/kan_report.js"),m=e("appmsg/malicious_wording.js"),c=e("biz_wap/utils/jsmonitor_report.js"),l=e("appmsg/related_article.js"),u=e("appmsg/share_biz.js"),d=u.shareBizTest,p=window.md5(window.user_uin),_=["testrd","otherrd"],h=0;
try{
...
img_height:"640",
link:i(y,r,o),
desc:"You can read the content of the original author below.",
title:"Article constitutes content laundering."
},function(){
n(y,fakeid,r,o,e.shareScene);
});
}else{
var r=1,a=t(k,"1");
e&&"favorite"==e.scene&&(r=24,a=t(k,"4"),l&&l.render&&l.render("share")),1==malicious_content_type&&(a="https://mmbiz.qlogo.cn/mmbiz_png/cVgP5bCElFiayFgbgEB9iaDt7hLicfz9RrXGM0LpaQ0TUic2gP7lbbqU3jCD8ibonicgIa3p99yjx1f1P26HChraeRUg/0?wx_fmt=png");
var o=Date.now(),m={
appid:v,
img_url:a,
img_width:"640",
...
var c=m.forbid_msg.replace("#op#","favorite"===e.scene?"Favorite":"Share");
...
link:i(y,2,o),
desc:"",
title:"Article constitutes content laundering. You can read the content of the original author below."
},function(){
...
if(window.customShareInfo&&"object"===_typeof(window.customShareInfo)&&_extends(m,window.customShareInfo),
"string"==typeof m.forbid_msg){
var c=m.forbid_msg.replace("#op#","Share");
return void(window.weui||window).alert(c);
}
