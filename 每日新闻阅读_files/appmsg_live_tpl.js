...
return j(t.height,t.inputHeight);
})),f.push(t));
},
...
show:function(t){
if(C()||t.forceFallback||t.forceFallbackIfUnsupport){
...
showType:1,
sendButtonWord:"Comment",
leftWords:"Comment",
rightWords:"Cancel",
editBoxHeight:120
}):"reply"===t.type&&(o.customParams={
showType:0,
sendButtonWord:"Reply"
