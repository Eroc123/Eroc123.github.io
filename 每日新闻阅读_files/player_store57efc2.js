...
"use strict";
function e(){
j.hasInit||(j.hasInit=!0,L=j.debug?console.log:function(){},l(),c("onBackgroundAudioStateChange"),
...
for(var u in j.mutexPlayers)for(var r=0,l=j.mutexPlayers[u].length;l>r;r++)s++;
for(var u in j.mutexPlayers)for(var r=0,l=j.mutexPlayers[u].length;l>r;r++){
var d=j.mutexPlayers[u][r];
if(d&&d!==i){
...
t.srcId="",t.albumId=e):(e=v(j.wxtag,t.src)||"",e&&(e=d(e)));
...
r||"function"!=typeof j.jsapiGlobalEvent[s]||(o.jsapiLog("onBackgroundAudioStateChange "+s+" unHandle;res:"+l),
...
var t=this._o.mid||"";
this._o.src?(this._g.mutexKey=this._o.src,this._g.jsapiSrcId=j.wxtag+"_"+this._o.wxIndex):(this._g.mutexKey=d(t),
...
var _=d.getAlbumCurAudio(),g=_.curIdx,f=_.curAudio;
...
},d.isTingSupportType()&&p.isTingOpen&&r&&(c.stateChangeCallback.play(0),c.stateChangeCallback.play=null)):e();
}else t=t||{},t.err_code=1,i(t);
};
L("setBackgroundAudioState params: setOpt",h),L("setTingAudioState params: tingOpt",y),
d.isTingSupportType()&&1*p.isTingOpen===1?I.invoke("setTingAudioState",y,function(t){
m(t);
...
L("operateTingAudio log: params: "+JSON.stringify(d||{})+", res: "+JSON.stringify(t||{})),
p(t);
