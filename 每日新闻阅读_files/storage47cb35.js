...
return{
commentLimit:b.getLimit("comment"),
urls:[],
scrollCount:0,
lastContent:"",
showMyAll:!1,
...
return this.commentData&&this.commentData.elected_comment_total_cnt?this.offset+b.FETCH_CMT_LEN>=this.commentData.elected_comment_total_cnt:!1;
},
...
return this.checkIfFansDaysNotRequired?"作者已设置关注7天后才可留言":this.checkIfFansNotRequired?"Follow first to comment":"";
},
...
return!this.showMyAll&&t>b.LIST_LIMIT;
},
...
mounted:function(){
var t=this;
this.deviceIsPc&&document.body.classList.add("pages_skin_pc"),this.deviceIsPc||(this.cmtEmotionPanel=new L({
...
H&&console.info("[Comment on Article] Request comment data:",r),o.info("[Appmsg comment] start get comment data, url:"+r),
m({
url:r,
dataType:"json",
success:function(i){
...
value:-1
}:this.offset+b.FETCH_CMT_LEN>=e.elected_comment_total_cnt?{
value:-1
}:{
...
default:
e.lastContent=n,window.weui.alert("System error. Try again later.");
}
...
showRemindWordCount:b.REMIND_WORD_COUNT,
...
P.style.removeProperty("margin-top")),b.unlockOrientation();
}
});
},
showCmtInput:function(t){
var e=this,n=b.lockOrientation();
...
var e=t.clipboardData.getData("text"),n=b.getLength(e),i=b.getLength(this.cmtInputValue);
...
var t=b.getLength(this.cmtInputValue);
...
default:
b.getLength(this.cmtInputValue)>=this.commentLimit&&t.preventDefault();
}
},
...
var e=this;
b.unlockOrientation(),this.$refs.cmtInput.blur(),this.showCmtInputStatus=!1,document.body.style.removeProperty("margin-bottom"),
...
t=t||b.getLength(this.cmtInputValue),this.cmtTips=t>=this.commentLimit-b.REMIND_WORD_COUNT&&t<this.commentLimit?"还可以输入"+(this.commentLimit-t)+"个字":t===this.commentLimit?"达到"+this.commentLimit+"字输入上限":t>this.commentLimit?"已超出"+(t-this.commentLimit)+"字":"";
},
...
var n="";
if(parseInt(e,10)>1e5)n="100k+";else if(parseInt(e,10)>1e4&&parseInt(e,10)<=1e5){
var t=""+parseInt(e,10)/1e4,i=t.indexOf(".");
n=-1===i?t+"0K":t.substr(0,i)+"."+t.charAt(i+1)+"0K";
...
function y(e,n){
var t="en"===window.LANG,i=t?"k":"0K",o="",r=1e4*n,a=t?10*n:n;
...
},G=[1,24,2,3,43,22,23,5],K=null,$=function(e){
var t=e.$container;
t&&!T.isInMiniProgram&&(K&&E.off(t,"tap",K),E.on(t,"tap",".js_go_profile",K=function(t){
