...
remove:function(e){
var t=this;
e.stopPropagation(),I.highlightEle(e.currentTarget),window.weui.confirm("comment"===this.itemType?"Delete this comment?":"Delete this reply?",{
...
}else y.newAlert("Deletion failed. Try again.");
},
error:function(){
y.newAlert("Network error. Try again.");
}
});
}
}]
...
default:
y.newAlert("System error. Try again later.");
}
