...
error:function(e){
console.log(e),t.errMsg="System busy. Please try again later.",n();
}
}):n();
}
function n(){
...
function p(){
S.gtVersion("7.0.6")||m.on(window,"unload",function(){
...
inPC:S.isWindows||S.isMac&&!S.isIOS,
fastForwardSec:15,
fastBackSec:15,
...
voiceid:o.songId,
action:t
}),S.gtVersion("7.0.6")&&!T.needReport11982&&(T.needReport11982=!0,I.addSpecificReport("music_data",l),
...
dataType:"json",
success:function(e){
e&&e.base_resp&&0===e.base_resp.ret?4===e.voice_verify_state?M("因违反相关法律法规，音频不可播放"):n():window.weui.alert("System busy. Please try again later.");
},
error:function(e){
console.log(e),window.weui.alert("System busy. Please try again later.");
}
}):n();
...
o.playArea&&o.playArea.setAttribute("aria-label","Play");else if(3===t)o.ctrlArea&&(o.ctrlArea.style.display="none"),
w.removeClass(r,o.playingCss),o.pauseCss&&w.removeClass(r,o.pauseCss),o.playdotDom&&(o.playdotDom.style.display="none",
this._g.canDragBar=!1),this._updateProgress(0),o.playArea&&o.playArea.setAttribute("aria-label","Play");else if(1===t||4===t){
var n=h.getPlaybackRate();
o.doubleSpeedBtn&&(o.doubleSpeedBtn.innerHTML=1===n?"倍速":n+"倍"),T.allComponent.forEach(function(e){
e===a?(o.ctrlArea&&(o.ctrlArea.style.display=""),o.playArea&&o.playArea.setAttribute("aria-label","Pause")):(e._o.ctrlArea&&(e._o.ctrlArea.style.display="none"),
e._o.playArea&&e._o.playArea.setAttribute("aria-label","Play"));
...
if(T.inPC){
var e=this,t=e._o;
t.playdotDom&&t.playdotDom.setAttribute("title",S.isMac?"按住option + 左右方向键可调":"按alt + 左右方向键可调"),
!T.inWechat&&t.playArea&&t.playArea.setAttribute("title",S.isMac?"按住option + 上下方向键可调音量":"按alt + 上下方向键可调音量"),
...
"frontend"===e.type&&(e.state&&z.dom.js_mpvedio.parentNode!==document.body?(z.dom.js_article.style.opacity=0,
window.requestAnimationFrame(function(){
document.body.appendChild(z.dom.js_mpvedio),z.dom.js_article.style.transition="opacity .3s";
})):e.state||z.dom.js_mpvedio.parentNode===z.dom.page_content||(z.dom.page_content.appendChild(z.dom.js_mpvedio),
setTimeout(function(){
