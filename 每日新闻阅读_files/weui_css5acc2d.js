...
if(e=0,B&&(B.style.display="none"),z&&(z.style.display="none"),H[F.POS_MID])for(var o=0;o<H[F.POS_MID];o++){
var a=k[M.getPosKeyDesc(F.POS_MID,o)];
...
if(6e4>=s?P.report120081(12):12e4>=s?P.report120081(13):s<E.AD_CACHE_TIME&&P.report120081(14),
...
Q=new c,Q.handleAdWithFrame(d.newAdInfos,d.midAdDataCount,i.appid),Y=new N,Y.config({
adElCountMapByPos:H,
...
var e=this;
"5"===window.item_show_type&&(P.isNativePage()||P.isWcSlPage())&&this.hasAdAfterVideo?x.onReceiveMPPageData(function(t){
t.data===E.GET_AD_DATA_AFTER_VIDEO_ACTION_NAME&&e.newAdInfos.map(function(e){
e.pos_type===F.POS_AD_AFTER_VIDEO&&x.sendMPPageData(JSON.stringify({
aInfo:e,
dataType:"adData"
}),"adWeb");
});
...
void(P.isWcSlPage()?x.setHasAdData4WcSlPlayer(!0):P.isNativePage()?x.createTailWebview(!0):(M.report115849(33),
