...
this.panelDel.innerHTML="Delete",this.panelDelWrp.appendChild(this.panelDel),this.panel.appendChild(this.panelDelWrp),
...
function a(e){
var a=arguments.length<=1||void 0===arguments[1]?"comment":arguments[1],o=n(e);
if(1>o)return t("comment"===a?"Comment cannot be blank":"回复不能为空"),{
valid:!1
};
var r=i(a);
return o>r?(t("字数不能多于"+r+"个"),{
valid:!1
}):{
valid:!0,
content:e
...
var i=t/1e3-e,a=n/1e3-e,o=new Date(n).getFullYear(),r=new Date(1e3*e);
return 3600>i?Math.ceil(i/60)+"分钟前":86400>a?Math.floor(i/60/60)+"小时前":172800>a?"Yesterday":604800>a?Math.floor(a/24/60/60)+"天前":r.getFullYear()===o?r.getMonth()+1+"/"+r.getDate():r.getFullYear()+"年"+(r.getMonth()+1)+"月"+r.getDate()+"日";
}
function r(e){
var t=e||y;
...
function l(e){
null===C&&null===T&&(C=document.createElement("input"),C.setAttribute("aria-hidden","true"),
C.style.cssText="position: absolute; left: -999999px;",C.readOnly=!0,document.body.appendChild(C),
T=document.createElement("button"),T.setAttribute("aria-hidden","true"),T.style.cssText="position: absolute; left: -999999px;",
document.body.appendChild(T),T.addEventListener("click",function(){
document.queryCommandEnabled("copy")?(document.execCommand("copy"),window.weui.toast("复制成功",750)):t("复制失败");
})),C.value=e,C.select(),C.setSelectionRange(0,e.length),T.click();
}
function d(e){
var t=arguments.length<=1||void 0===arguments[1]?6:arguments[1],n="",i=0,a=0,o=e.length,r=!0,s=!1,u=void 0;
try{
for(var c,l=e[Symbol.iterator]();!(r=(c=l.next()).done);r=!0){
var d=c.value;
if(a>=t)break;
/\w/.test(d)?(a+=.5,n+=d):(a++,t>=a&&(n+=d)),i++;
}
}catch(m){
s=!0,u=m;
}finally{
...
return!b.isIPad&&b.isWechat&&v.invoke("handleDeviceInfo",{
...
function w(){
!b.isIPad&&b.isWechat&&v.invoke("handleDeviceInfo",{
action:"setOrientation",
orientation:0,
lock:!1
},function(){});
}
var p=e("appmsg/i18n.js"),g=e("pages/utils.js"),f=e("biz_wap/utils/device.js"),b=e("biz_wap/utils/mmversion.js"),v=e("biz_wap/jsapi/core.js"),h=b.is_wxwork,_=f.os.pc&&!h,y="http://mmbiz.qpic.cn/mmbiz/ByCS3p9sHiak6fjSeA7cianwo25C0CIt5ib8nAcZjW7QT1ZEmUo4r5iazzAKhuQibEXOReDGmXzj8rNg/0",z=100,x=10,j=2,k=10,C=null,T=null;
return{
FETCH_CMT_LEN:z,
FETCH_RPY_LEN:x,
LIST_LIMIT:j,
...
r.newAlert("System error. Try again later.");
});
},
...
"use strict";
var e=t("biz_common/dom/event.js"),i=t("pages/utils.js"),n=t("pages_new/modules/comment/utils.js"),o=t("biz_wap/utils/mmversion.js"),s=t("pages_new/modules/bottom_modal/bottom_modal.js"),a=t("common/navShadow.js"),l=t("common/keyboard.js"),u=t("appmsg/emotion/emotion.js"),m=t("appmsg/emotion/emotion_panel.js"),r=t("pages_new/modules/comment/write_dialog/write_dialog.html.js"),c=t("pages_new/3rd/vuex.js"),p=c.mapGetters,h="discuss_write_dialog_android_onfocus",d=[],f=0,g={};
...
return e.modalOpt.extClass=i===t?"":h,!0;
}
return!1;
});
});
...
var b=!1;
return l.onGetKeyboardHeight(function(t){
var e=t.keyboard;
...
computed:_extends({},p("mp-comment",["canC2cReply"]),{
placeholder:function(){
return"comment"===this.type?"Comments are visible to everyone after being approved by the Official Account":this.canC2cReply?"Replies are visible to everyone":"Replies are visible to everyone after being approved by the Official Account";
},
limit:function(){
return n.getLimit(this.type);
}
}),
watch:{
type:function(t){
...
case"comment":
this.modalOpt.btnText="Submit",this.modalOpt.transparentMask=!1,this.modalOpt.animationType="bottom",
this.modalOpt.closeBtnType="close";
break;

case"reply":
this.modalOpt.btnText="Reply",this.modalOpt.transparentMask=!1,this.modalOpt.animationType="bottom",
this.modalOpt.closeBtnType="close";
}
}
},
...
limit:this.limit,
counter:function(t){
return n.getLength(t);
},
onChange:function(e){
var i=e.type,n=e.value;
("action"!==i||"done"!==n)&&t.onInputChange();
},
onShow:function(t){
g.keyboardHeight=t;
},
...
var t=n.getLength(this.inputValue);
this[t&&t<=this.limit?"enableSubmit":"disableSubmit"](),this.setInputTips(t);
},
onPaste:function(t){
var e=t.clipboardData.getData("text"),i=n.getLength(e),o=n.getLength(this.inputValue);
if(o+i>this.limit){
t.preventDefault();
for(var s=this.limit-o,a="",l=0,u=e.length;u>l&&s>0&&(s-=/[^\x00-\xff]/.test(e[l])?1:.5,
!(0>s));l++)a+=e[l];
...
default:
n.getLength(this.inputValue)>=this.limit&&t.preventDefault();
}
},
...
setTimeout(function(){
t.inputStyle={},t.showFakeInput=!1,t.$refs.modal.getBdEle().scrollTop=0,document.documentElement.scrollTop=i,
...
this.setReplyTo(t.nickName,t.toContent),t.value&&i.trim(t.value)?(this.setInputValue(t.value),
