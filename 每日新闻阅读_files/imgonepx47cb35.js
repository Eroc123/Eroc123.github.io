...
if(e.is_paid){
var l="Paid";
_.addClass(s,"wx_icon_pay_tag"),_.addClass(s,"wx_icon_pay_tag_paid"),s.innerText=l,
a.appendChild(s);
}else if(e.is_pay_subscribe){
var r="Pay";
_.addClass(s,"wx_icon_pay_tag"),s.innerText=r,a.appendChild(s);
}
...
r.style.position="relative",r.setAttribute("role","listbox");
...
cb:function(){
l(function(i){
C.hideLoading(),p=i.base_info.is_reverse,c=i.base_info.cur_article_num,u=c?1:0,r.appendChild(e(i.article_list,!0)),
w=i.article_list[0],h=i.article_list[i.article_list.length-1],n(i),f||C.showEndLine();
var t=r.childNodes[v];
setTimeout(function(){
t.offsetTop+t.clientHeight>C.contentAreaWrp.clientHeight&&C.scrollTo(0,r.offsetHeight);
},200);
});
},
onShow:function(){
...
n(i.getalbum_resp),r.appendChild(e(a,!1,!0)),d=d.concat(a),C.finishPullUpLoad(),
...
n(i.getalbum_resp);
var s=e(a,!1,!1),l=r.firstChild;
r.insertBefore(s,l),d=a.concat(d),C.scrollTo(0,l.offsetTop-62),setTimeout(function(){
...
C=new m(r,y),C.showLoading(),C.show(),o(r);
}
function d(){
...
"use strict";
var n=e("biz_common/dom/event.js"),s=e("biz_common/dom/class.js"),r=e("biz_wap/jsapi/core.js"),a=e("pages/utils.js"),m=a.formatReadNum,l=e("appmsg/retry_ajax.js"),d=e("appmsg/set_font_size.js"),c=e("common/comm_report.js"),p=e("appmsg/related_article.js"),w=e("appmsg/like_profile.js"),_=e("common/utils.js"),k=e("biz_wap/utils/device.js"),u=e("biz_wap/utils/mmversion.js"),h=e("appmsg/appmsg_report.js"),g=e("appmsg/rec_report_key.js"),j=g.RecActionType,b=g.reportRecAction,f=function(e){
...
if(e&&e.length){
f("js_like_wording").textContent="Wow",f("js_parise_wording").textContent="Like";
...
("100k+"!==e||"100k+"!==e)&&(y.likeNumDom.innerHTML=m(y.likeNum)),y.likeNumDom.style.display="",
...
var e=y.likeNumDom.innerHTML;
y.likeNum>=0&&"100k+"!==e&&"100k+"!==e&&(y.likeNumDom.innerHTML=m(y.likeNum)),0===y.likeNum&&(y.likeNumDom.style.display="none"),
y.likeBottomBtn.removeAttribute("aria-describedby");
},x=[],I=function(e){
"function"==typeof e&&x.push(e);
},C=function(e){
y.isLike=y.isLike?0:1,y.isLike?L():z();
...
return y.likeBottomBtn&&y.likeBottomBtn.disabled===!0?void 0:window.is_temp_url?void("5"!==window.item_show_type||!_.isNativePage()||k.os.pc?window.weui.alert("Unable to do this in preview"):t("Unable to do this in preview")):void C(e);
};
...
action:"doFavorite"
}),p&&p.render&&p.render("favorite"),B(["collect"]),h.shareReport({
...
var e=el_like.getAttribute("like"),i=el_likeNum.innerHTML,o=parseInt(e)?parseInt(e):0,t=o?0:1,n=parseInt(i)?parseInt(i):0,s=opt.appmsgid||opt.mid,a=opt.itemidx||opt.idx;
if(reportRecAction(RecActionType.kSeen,t),o){
...
}else if(g.supportZaikanAutho)WeixinJSBridge.invoke("handleHaokanAction",{
...
var l=/(?:\?|&)search_click_id=([^&]*)(?:&|$)/.exec(window.location.search);
RetryAjax({
url:"/mp/appmsg_like?__biz="+opt.biz+"&mid="+opt.mid+"&idx="+opt.idx+"&like="+t+"&f=json&appmsgid="+s+"&itemidx="+a,
data:{
...
if(o.length>0){
var a=o[0]||{},l=a.clientY;
i=l>startY&&0>=t?!1:startY>l&&t+n>=s?!1:!0,i||e.preventDefault();
}
},isShow=function(e){
...
o&&o>0&&(el_friend_like.innerHTML="%s friend(s) reading".replace("%s",o),document.getElementById("js_friend_like_word").innerText='Go to "Discover" > "Top Stories" to view',
...
"100k+"!==e&&(el_likeNum.innerHTML=formatReadNum(realLikeNum)),el_likeBtn.setAttribute("aria-describedby","js_a11y_like_btn_tips"),
...
case 1:
(4===e||5===e)&&showToast(4===e?"Posted":n);
}
...
supportZaikanAutho:(Device.os.iphone||Device.os.ipad)&&mmversion.isWechat&&mmversion.gtVersion("8.0.19",1)||Device.os.android&&mmversion.isWechat&&mmversion.gtVersion("8.0.19",1)
};
return{
...
var s=e("appmsg/log.js"),t=e("biz_wap/utils/ajax.js"),_=e("rt/appmsg/getappmsgext.rt.js"),n=e("biz_common/utils/wxgspeedsdk.js"),a=e("biz_common/utils/url/parse.js"),o=void 0;
return{
getData:i
};
...
var w=o(n);
return w&&(w.style.width=s.perLine*d+"px"),s.perLine;
},_=function(){
...
window.innerWidth!==i&&(i=window.innerWidth,w(e),s.hasInit&&r.render(s.perLine));
}),n.isWindows&&t.onFontScaleChange(w);
}(),s.perLine||w(e),s.perLine):0;
},m=function(e,t){
s.hasInit=!0;
var w=e.author_id||window.author_id;
...
g&&(g.innerText="Like the Author");
}else n.isAndroid&&(o("js_preview_reward_author_name").style.display="none");
}else!n.isInMiniProgram&&(d.indexOf("WindowsWechat")>-1||n.isIOS||n.isAndroid)?(r.handle(e,_({
