...
var r=i[o];
r.setAttribute("data-reservation",1===n?1:0),r.querySelector(".js_channel_btn_operation_wording").innerHTML=1===n?"已预约":"Reserve",
...
if(X.highlightEle(i),window.is_temp_url)return window.weui.alert("Unable to do this in preview"),
!1;
...
function W(){
b(),A(),E(),I(),y(),T(),q.on(window,"scroll",k);
}
function O(e,t){
if(t){
