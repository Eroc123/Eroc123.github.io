...
}catch(o){}else s.info("[Player] success get immersive data, immersive data is empty");
},
error:function(){
...
var s=e("biz_wap/jsapi/log.js"),n=e("biz_wap/utils/ajax.js");
return{
getImmersivePlayerData:i,
oprImmersivePlayerData:o
};
...
define("pages_new/common_share/video/player/player.js",["page/pages/video_new.css","pages_new/3rd/vue.js","pages_new/3rd/vuex.js","biz_wap/jsapi/log.js","pages_new/common_share/video/player/player.html.js","biz_wap/utils/device.js","biz_wap/utils/mmversion.js","new_video/ctl.js","pages/version4video.js","biz_wap/jsapi/core.js","new_video/plugin/util.js","biz_wap/utils/jsmonitor_report.js","common/utils.js","biz_wap/utils/ajax.js","appmsg/set_font_size.js","pages_new/modules/toast/toast.js","biz_wap/utils/openUrl.js","biz_common/utils/url/parse.js","pages/utils.js","common/safeAreaInsets.js"],function(e){
"use strict";
...
var o=e("biz_wap/jsapi/log.js"),a=e("pages_new/common_share/video/player/player.html.js"),r=e("biz_wap/utils/device.js"),h=e("biz_wap/utils/mmversion.js"),u=e("new_video/ctl.js"),l=e("pages/version4video.js"),c=e("biz_wap/jsapi/core.js"),d=e("new_video/plugin/util.js"),p=e("biz_wap/utils/jsmonitor_report.js"),g=e("common/utils.js"),f=e("biz_wap/utils/ajax.js"),m=e("appmsg/set_font_size.js"),_=m.fontSizePlugin;
t.use(_);
var v=e("pages_new/modules/toast/toast.js"),y=e("biz_wap/utils/openUrl.js"),S=e("biz_common/utils/url/parse.js"),T=e("pages/utils.js"),w=T.formatReadNum,b={
...
supportZaikanAutho:(r.os.iphone||r.os.ipad)&&h.isWechat&&h.gtVersion("8.0.19",1)||r.os.android&&h.isWechat&&h.gtVersion("8.0.19",1),
...
try{
b._debug=window.location.href.indexOf("&_debug=1")>0;
}catch(k){
b._debug=!1;
}
var P=h.getInner();
window.parent===window&&h.isWechat&&!h.isInMiniProgram&&(r.os.iphone&&h.gtVersion("7.0.15",1)&&r.os.getNumVersion()>=10.3||r.os.android&&(P>"27001037"&&"27001060">P||P>="27001100")&&r.os.getNumVersion()>=5)&&(b.wcSlPlayerSupport=!0),
console.log("support wcslplayer",b.wcSlPlayerSupport);
var A=function(e){
return b._debug&&console.log(e);
},I=function(e,t){
...
return _extends({},b.allPlayersOfPage);
},C=function(){
...
for(var s=!1;e&&!(s=R(e,i));)e=e!==t&&null!=e&&e.nodeType!==e.DOCUMENT_NODE&&e.parentNode;
return s;
},M={
...
components:_defineProperty({},v.name,v),
data:function(){
...
src:function O(){
var O=this.opt.src;
return this.opt.extinfo&&this.opt.extinfo.vid&&(O+="&vid="+this.opt.extinfo.vid+"&format_id="+this.opt.formatId),
O+="&support_redirect=0&mmversion="+h.get(),this.useQuic?O.replace("mpvideo.qpic.cn","wxsnsdy.wxs.qq.com/130/20210/snssvpdownload/SH/reserved"):O;
},
coverFit:function(){
...
width:function(){
return Math.min(this.opt.width||300,b.screenWidth);
},
height:function(){
return Math.min(this.opt.height||300,b.screenLength);
},
ratio:function(){
...
nickname:function(){
return this.opt.bizNickName||"Unnamed Official Account";
},
readNum:function(){
return w(this.opt.readNum);
},
praiseNum:function(){
return w(this.opt.praiseNum);
},
likeNum:function(){
return w(this.opt.likeNum);
},
isPraised:function(){
...
return b.showFullscreenMenu&&!!this.opt.showFullscreenMenu;
},
...
var e={
width:(this.isLandscape?b.screenLength:b.screenWidth)+2+"px",
height:(this.isLandscape?b.screenWidth:b.screenLength)+"px",
position:"fixed",
padding:"0 1px",
left:"-1px",
top:0,
...
width:(this.isLandscape?b.screenLength:b.screenWidth)+"px",
height:(this.isLandscape?b.screenWidth:b.screenLength)+"px"
}:_extends({
display:"block",
width:this.width+"px",
...
return{
bottom:(b.screenLength-Math.min(b.screenLength,b.screenWidth/this.videoRatio))/2+16+"px"
};
},
maxPlayerFontScale:function(){
var e=1.4,t=1.18;
return this.fullscreenStatus?e:this.opt.duration>=3600?t:this.width<390?1:t;
},
...
b.allPlayersOfPage[this.id]=this,c.on("onNetWorkChange",this.onNetworkChange),c.on("menu:haokan",this.onLikedCommentWrite),
c.on("menu:share:appmessage",this.showSubscribeBtn),c.on("menu:share:timeline",this.showSubscribeBtn),
...
r.os.android?c.on("onOrientationsChange",this.onAndroidOrientationChange):(this.isFeFullscreen||this.isWcSlPlayer&&!this.isImmersiveMode)&&window.addEventListener("resize",this.onWindowResize)):r.os.ipad&&this.isFeFullscreen&&(this.onIPadOrientationChange(),
window.addEventListener("orientationchange",this.onIPadOrientationChange)),!this.supportImmersiveMode&&this.isWcSlPlayer&&r.os.iphone&&c.on("onPageStateChange",this.onIOSPageStateChange),
this.isImmersiveMode&&(this.setFullscreenStatus({
status:1
}),this.handleFullscreenChange({
state:!0,
type:"immersive"
}),c.invoke("setNavigationBarButtons",{
right:{
color:"#FFFFFFCC",
disableMinimizeBlock:!0
}
}),c.on("onNavigationBarRightButtonClick",this.onShowFullscreenMenu)),this.needFeFullscreen&&(window.addEventListener("unload",this.exitFullscreen),
c.on("onMPCustomMenuItemClick",this.onFullscreenMenuClick),this.isFeFullscreen&&r.os.android&&c.on("onExitFullscreen",this.__onAndroidExitFullscreen=function(){
return e.exitFullscreen({
directExit:!0
});
})),this.canShareVideo&&this.supportNativeFullPlayer&&!this.needFeFullscreen&&(this.__jsapiFullscreenErrCnt=0,
setTimeout(this.getCoverBase64,1e3),c.on("onMPPageAction",this.onJsapiExitFullscreen));
},
beforeDestroy:function(){
delete b.allPlayersOfPage[this.id],c.remove("onNetWorkChange",this.onNetworkChange),
c.remove("menu:haokan",this.onLikedCommentWrite),c.remove("menu:share:appmessage",this.showSubscribeBtn),
c.remove("menu:share:timeline",this.showSubscribeBtn),document.body.removeEventListener("mousemove",this.onProgressMouseMove),
...
r.os.android?c.remove("onOrientationsChange",this.onAndroidOrientationChange):(this.isFeFullscreen||this.isWcSlPlayer&&!this.isImmersiveMode)&&window.removeEventListener("resize",this.onWindowResize)):r.os.ipad&&this.isFeFullscreen&&window.removeEventListener("orientationchange",this.onIPadOrientationChange),
!this.supportImmersiveMode&&this.isWcSlPlayer&&r.os.iphone&&c.remove("onPageStateChange",this.onIOSPageStateChange),
this.isImmersiveMode&&c.remove("onNavigationBarRightButtonClick",this.onShowFullscreenMenu),
this.needFeFullscreen&&(window.removeEventListener("unload",this.exitFullscreen),
c.remove("onMPCustomMenuItemClick",this.onFullscreenMenuClick),this.isFeFullscreen&&r.os.android&&c.remove("onExitFullscreen",this.__onAndroidExitFullscreen)),
this.canShareVideo&&this.supportNativeFullPlayer&&!this.needFeFullscreen&&c.remove("onMPPageAction",this.onJsapiExitFullscreen),
...
this.hideMidPlayBtn()):(this.setFullscreenStatus({
status:0
}),this.setSeekingStatus({
status:0
})),c.invoke("getNetworkType",{},function(t){
var i=b.nettypeMap[t.err_msg]||"fail";
("network_type:edge"==t.err_msg||"network_type:wwan"==t.err_msg)&&(t.detailtype&&b.cellType.indexOf(t.detailtype)>-1||t.subtype&&b.cellType.indexOf(t.subtype)>-1)&&(i=t.detailtype||t.subtype),
e.__lastNetworkType={
networkType:i,
simType:t.simtype
};
...
.1>=i&&(t.needToFit=!0,I("objectFit","fill")&&(t.supportObjectFit=!0,this.fitVideo=!0));
}
...
e>0&&(0===t||this.__serialTimeupdateCache[t-1].currentTime!=e)&&(this.__serialTimeupdateCache.length>=b.timeupdateCacheCount&&this.__serialTimeupdateCache.shift(),
...
if(this.__serialTimeupdateCache.length<b.timeupdateCacheCount)return!1;
var e=this.__serialTimeupdateCache.length,t=this.__serialTimeupdateCache[e-1],i=this.__serialTimeupdateCache[e-b.timeupdateCacheCount];
...
var e=this;
Object.keys(b.allPlayersOfPage).forEach(function(t){
e.id!==t&&(b.allPlayersOfPage[t].pause(),b.allPlayersOfPage[t].showMidPlayBtn(),
b.allPlayersOfPage[t].hideControlBar());
});
},
...
null!==this.__replaySec&&(A(this.id+":timeupdate __replaySec"),e.pause(),e.currentTime=this.__replaySec,
...
onEnded:function(){
A("player inner is end:"+this.isEnd()),this.isEnd()&&this.onVideoEnded();
},
...
status:"pause",
subStatus:""
})),delete this.__statusBeforeSeek),A("video seeked event");
},
onSeeking:function(){
A("seeking,__hasBegunPlaying:"+this.__hasBegunPlaying),this.__hasBegunPlaying&&(this.changeStatus({
status:"loading",
subStatus:"seeking"
}),this.showLoading());
},
...
if(A("waiting,__hasBegunPlaying:"+this.__hasBegunPlaying),this.__hasBegunPlaying){
this.changeStatus({
status:"loading",
subStatus:"waiting"
...
},b.loadingTimeout),this.__waitingTimeoutId&&(clearTimeout(this.__waitingTimeoutId),
this.__waitingTimeoutId=null);
var s=0;
try{
for(var n in b.allPlayersOfPage)if(b.allPlayersOfPage.hasOwnProperty(n)&&s++,s>1)break;
}catch(o){}
...
var i=t.src;
e.showLoading(),e.showCover(),t.pause(),t.src=i,t.load(),t.play(),A(e.id+":waiting timer");
}
},1e4)),this.triggerEvent("waiting");
}
},
onPlay:function(e){
A(this.id+":play playing"),this.changeStatus({
status:"play",
subStatus:e.type
...
onPause:function(){
A(this.id+":video pause event"),this.changeStatus({
status:"pause",
subStatus:""
...
n+="|"+this.src,n=encodeURIComponent(n),f({
type:"GET",
dataType:"json",
timeout:3e4,
...
this.triggerShowSubscribeEvent(),c.invoke("handleDeviceInfo",{
...
this.hideSubSetting(),this.resetVideoFullPortraitAlign(),c.invoke("handleDeviceInfo",{
action:"setKeepScreenOn",
enable:!1
},function(){}),h.isIOS&&setTimeout(function(){
c.invoke("setNavigationBarColor",{
wxcolor:{
light:"#FFFFFF",
dark:"#191919"
},
alpha:1
}),c.invoke("handleDeviceInfo",{
...
for(var t=e.$refs.video,i=e.$refs.poster,s=h.isIOS&&b.screenLength>=812?34:0,n=Math.min(b.screenLength,b.screenWidth/e.videoRatio),o=[0,56+s,84+s,150+s,190+s],a=1;a<o.length;a++)if(.55*b.screenLength-n/2<o[a]){
var u=function(){
for(var s=0,h=a-1;h>=0&&(s=(b.screenLength-n)/2-o[h],!(n/2-s<b.screenLength/2));h--);
...
r.os.android&&t&&!t.style.marginTop&&(t.style.marginTop=-.05*b.screenLength+"px",
t.style.marginBottom=.05*b.screenLength+"px");
}();
},
...
status:1
}),this.touchToastSeperator="/",this.touchToastPercent=100*e/this.duration,this.touchToastCurVal=F(e),
...
t.showTouchVerticalOprBar("亮度",o),t.__setBrightnessChangeEventEmitTimeoutId&&clearTimeout(t.__setBrightnessChangeEventEmitTimeoutId),
...
},1e3)):(o=t.$refs.video.volume+o,t.$refs.video.volume=o,t.showTouchVerticalOprBar("音量",o),
...
return V(e,this.$el,"div.js_progress_bar,div.js_control,div.js_video_fullscreen_profile")||e.classList.contains("js_progress_bar")||e.classList.contains("js_control")||e.classList.contains("js_video_fullscreen_profile");
},
...
s>=20&&this.touchMoveHorizontally(e)),this.clearFastForwardTimeout();
}
},
...
},this.pause(),this.showControlBar(),this.showSeekingStatus(),h.isIOS&&!this.fullscreenStatus&&c.invoke("handleDeviceInfo",{
...
(r||h>=.5)&&(this.__seekingData.dragTime=a,A("onPointerMoveHandler set currentTime, dragTime:"+a+" currentTime:"+this.$refs.video.currentTime),
...
A("onPointerUpHandler dragTime:"+n+" currentTime:"+this.$refs.video.currentTime),
...
})),this.hideSeekingStatus(),this.hideControlBarAfterTimeout(),h.isIOS&&!this.fullscreenStatus&&c.invoke("handleDeviceInfo",{
action:"disableInteractivePop",
disable:!1
});
},
...
e.fullscreenStatus&&!e.isImmersiveMode&&c.invoke("handleDeviceInfo",{
...
status:1
}),this.resetVideoFullPortraitAlign(),i()):1===this.orientationStatus&&0===e.newOrientation&&(this.setOrientationStatus({
status:0
}),this.setVideoFullPortraitAlign(),i());
}
},
onWindowResize:function(){
this.videoRatio<=1||this.fullscreenStatus&&(this.isLandscape||b.outerWidth===window.outerWidth?this.isLandscape&&b.outerWidth===window.outerWidth&&(this.setOrientationStatus({
status:0
...
status:1
}),this.resetVideoFullPortraitAlign(),this.isWcSlPlayer&&!this.enableWcSlPlayerFullscreenAfterOrientationChange&&this.$refs.video.requestFullscreen(90,{
updateStyleOnly:!0
})));
},
...
status:1
}),e.resetVideoFullPortraitAlign(),e.isWcSlPlayer&&!e.enableWcSlPlayerFullscreenAfterOrientationChange&&e.fullscreenStatus&&e.$refs.video.requestFullscreen(90,{
updateStyleOnly:!0
}));
...
!this.fullscreenStatus&&e&&e.active&&(c.invoke("handleDeviceInfo",{
action:"enableFullScreen",
enable:!0
}),c.invoke("handleDeviceInfo",{
action:"enableFullScreen",
...
return E()||this.syncSubscribeStatus(),this.isWcSlPlayer?void(E()||!r.os.iphone||this.isImmersiveMode||!this.fullscreenStatus||this.isLandscape||c.invoke("handleDeviceInfo",{
action:"enableFullScreen",
enable:!0,
orientation:0,
animate:!1
})):void(E()?this.hasBegunPlaying()&&this.isPlay()&&(this.pause4outer(),this.__pausedWhenInvisible=!0):this.__pausedWhenInvisible&&(delete this.__pausedWhenInvisible,
this.hasBegunPlaying()&&!this.isEnd()&&this.play4outer()));
},
onNetworkChange:function(e){
e&&(e.networkType||(e.networkType=e.netType),e.networkType&&e.simType&&(this.__lastNetworkType&&this.__lastNetworkType.networkType===e.networkType&&this.__lastNetworkType.simType===e.simType||(d.isMobileNetwork(e.networkType)&&1!==e.simType&&this.__lastNetworkType&&("wifi"===this.__lastNetworkType.networkType||d.isNoneNetwork(this.__lastNetworkType.networkType))&&(this.__isUserPause=!1,
this.__pauseNetType=null,!this.isPlay()&&!this.isEnd()&&this.isPause()&&this.hasBegunPlaying()?(this.__isUserPause=!0,
this.__pauseNetType=this.__lastNetworkType.networkType):this.isPlay()&&("wifi"===this.__lastNetworkType.networkType&&d.isVideoNeedFlowNotice(this.opt.flow,2)||d.isNoneNetwork(this.__lastNetworkType.networkType)&&d.isVideoNeedFlowNotice(this.opt.flow,4))&&this.showFlowNotice()),
...
},100)),this.__hideLikedCommentTipsTimeoutId&&(clearTimeout(this.__hideLikedCommentTipsTimeoutId),
...
"number"!=typeof e&&(e=1),(t||0===window.isFans&&b.supportSubscribe&&(0===this.subscribeStatus&&1===e||1===this.subscribeStatus&&2===e))&&(this.subscribeStatus=e,
...
var e=this;
if(this.isFeFullscreen)return void c.invoke("handleDeviceInfo",{
action:"setOrientation",
orientation:90,
lock:!!r.os.android
},function(t){
...
-1!==t.err_msg.indexOf(":ok")&&(c.invoke("handleDeviceInfo",{
action:"disableInteractivePop",
disable:!0
}),r.os.ipad?e.onIPadOrientationChange():e.videoRatio<=1&&c.invoke("handleDeviceInfo",{
action:"setOrientation",
orientation:0,
lock:!0
}));
});
},50)):c.invoke("handleDeviceInfo",{
action:"enableFullScreen",
enable:!0,
orientation:0
...
var d=t.getBoundingClientRect(),p={
left:d.left,
top:d.top,
height:d.bottom-d.top,
width:d.right-d.left
},g=this.opt.extinfo,f=g&&g.vid||"",m={
...
bizUsrName:o,
bizNickName:a,
videoUrl:S.addParam(this.opt.src,"video_md5",this.opt.videoMd5||""),
...
},2e3)),c.invoke("handleMPPageAction",m,function(t){
...
("AbortError"===e.name||"NotAllowedError"===e.name)&&c.invoke("getNetworkType",{},function(){
...
l.device.inWechat&&this.__lastNetworkType&&this.__lastNetworkType.networkType&&this.__lastNetworkType.simType&&d.isMobileNetwork(this.__lastNetworkType.networkType)&&1!==this.__lastNetworkType.simType&&d.isVideoNeedFlowNotice(this.opt.flow,this.flowNum?5:1)&&this.showFlowNotice();
},
...
this.__isUserPause&&l.device.inWechat&&("wifi"===this.__pauseNetType&&d.isVideoNeedFlowNotice(this.opt.flow,3)||d.isNoneNetwork(this.__pauseNetType)&&d.isVideoNeedFlowNotice(this.opt.flow,4)?this.showFlowNotice():(this.__isUserPause=!1,
...
return window.__failConfigWxOpen?!1:this.__fallbackFromWcSlVideoToH5Player?!1:b.wcSlPlayerSupport;
},
...
var t=this;
if(b.statusDefine[e.status]&&(!e.subStatus||b.subStatusDefine[e.subStatus]||"error"===e.status)&&(this.status!==e.status||this.subStatus!==e.subStatus)){
var i=0;
...
A(o),this.triggerEvent("statusChange",{
...
this.__waitingTimeoutId=null),e.pause(),A(this.id+":pause function"));
},
...
console.info("[视频点击播放耗时]",e),this.__firstPlayStart=null,this.triggerEvent("firstBufferingTime",{
bufferingTime:e,
...
shareVideo:function(){
return this.opt.extinfo&&this.opt.extinfo.preview?void window.weui.alert("预览状态下无法分享视频"):void(this.canShareVideo&&((this.needFeFullscreen||r.os.ipad)&&this.supportImmersiveMode?(c.invoke("handleMPPageAction",{
action:"share"
...
return this.opt.extinfo&&this.opt.extinfo.preview?void window.weui.alert("预览状态下无法点赞视频"):(this.triggerEvent("praiseVideo"),
void(this.isPraised&&this.showSubscribeBtn()));
},
likeVideo:function(){
if(this.opt.extinfo&&this.opt.extinfo.preview)return void window.weui.alert("预览状态下无法在看视频");
if(this.isInPaySubscribe)return void window.weui.alert("付费图文内视频暂不支持在看");
1===this.fullscreenStatus&&1===this.orientationStatus&&this.exitFullscreen();
var e=this;
return b.supportZaikanAutho&&!e.isLiked?void setTimeout(function(){
...
var t=e.result;
0!==t&&c.invoke("handleHaokanAction",{
...
var t=this;
return this.opt.extinfo&&this.opt.extinfo.preview?void window.weui.alert("预览状态下无法在看视频"):this.isInPaySubscribe?void window.weui.alert("付费图文内视频暂不支持在看"):void(this.fullscreenStatus&&this.needFeFullscreen&&this.supportImmersiveMode&&!function(){
1===t.fullscreenStatus&&1===t.orientationStatus&&t.exitFullscreen();
var i=t,s=e;
b.supportZaikanAutho?setTimeout(function(){
WeixinJSBridge.invoke("handleHaokanAction",{
action:"checkSyncHaoKanPermission"
},function(e){
var t=e.result;
...
this.isImmersiveMode?y.openUrlWithExtraWebview(location.href.replace("#rd","").replace("item_show_type=16","").replace(/&scene=\d*/,"")+"&scene=206#rd"):this.exitFullscreen(),
this.triggerEvent("openSourcePage");
},
clickSubscribe:function(){
var e=this;
0===window.isFans&&b.supportSubscribe&&1===this.subscribeStatus&&(c.invoke("quicklyAddBrandContact",{
