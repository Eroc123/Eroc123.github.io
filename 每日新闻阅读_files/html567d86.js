...
for(var a,c,u=W["cp"+i],d=0,p=Math.max(o.length,n.length);p>d;++d){
...
function d(){
return f?"ios":m?"android":l?"mac_os":h?"windows":"unknown";
}
var p=navigator.userAgent,f=/(iPhone|iPad|iPod|iOS)/i.test(p),g=/Windows\sPhone/i.test(p),m=/(Android)/i.test(p),w=/MicroMessenger\/([\d\.]+)/i.test(p),l=/mac\sos/i.test(p),h=/windows\snt/i.test(p)&&!g,v=/MPAPP\/([\d\.]+)/i.test(p),M=/iPad/i.test(p),P=m&&/miniprogram/.test(p.toLowerCase())||"miniprogram"==window.__wxjs_environment,I=w&&/wxwork/i.test(p),W={
"cp-1":function(n,t){
return t>n;
},
cp0:function(n,t){
...
if(m&&s()){
var x="0x"+s().substr(-2);
parseInt(x)>=64&&parseInt(x)<=79&&(_=!0);
}
return{
get:t,
getMac:e,
...
var l=e("biz_wap/utils/ajax.js"),I=e("biz_wap/jsapi/core.js"),w=e("biz_wap/utils/jsmonitor_report.js"),h={
canJumpOnTap:!1,
isNonWechat:!1,
data:null,
appidInfoResp:null,
